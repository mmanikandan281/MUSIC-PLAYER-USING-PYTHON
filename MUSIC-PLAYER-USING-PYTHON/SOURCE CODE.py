...
class MusicPlayer:
    ...
    def __init__(self, root):
        ...
        for song in list_songs('E:\pg study\git\MUSIC-PLAYER-USING-PYTHON\MUSICS'):
    ...
    def play_song(self):
        ...
        pygame.mixer.music.load(os.path.join('E:\\pg study\\git\\MUSIC-PLAYER-USING-PYTHON\\MUSICS', selected_song))
